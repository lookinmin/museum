...
export default function Model(props) {
  ...
  const beam_material = new THREE.MeshStandardMaterial({ side: THREE.BackSide, color: "#101010", metalness: 0.5, roughness: 0.8 })
    ...
    console.log(props.is_close.current)
    if(props.is_close.current){
  ...
  return (
    <group onClick={(e)=>{move_init(props.pos1,props.pos2);e.stopPropagation()}} ref={group} {...props} dispose={null}>
      ...
      <Text3D font={"/model/leferi.json"} rotation={[0,Math.PI*-0.5,0]} position={[7,5,8.2]}>
        Car
        <meshNormalMaterial />
      </Text3D>
      <Text3D font={"/model/leferi.json"} rotation={[0,Math.PI*0.5,0]} position={[-7,5,12.5]}>
        Phone
        <meshNormalMaterial />
      </Text3D>
